  ...
  return (
    <section className="px-10 py-24 max-w-[1200px] mx-auto" id="mais-vendidos">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {bestSellers.map((car) => (
          <div key={car.id} className="bg-panel border border-line rounded-md overflow-hidden transition-transform hover:-translate-y-1.5 hover:border-blue-500">
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col gap-1 border-t border-line pt-4">
                ...
                <span className="font-mono text-lg text-blue-500">{car.priceFrom}</span>
              </div>
            </div>
          </div>
        ))}
